(function() {
    ...
    shoppers.forEach(x => {
        let finalAmount = x.amount *0.88;
        if (x.amount > discountPrice){
            console.log(`${x.name} spent ${x.amount}, and qualifies for the 12% discount. Total cost is $${finalAmount}.`)
        } else {
            console.log(`${x.name} does not qualify for discount. Total cost is $${x.amount}.`)
        }
    });
