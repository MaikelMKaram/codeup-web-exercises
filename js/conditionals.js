...
function calculateTotal(num,amt){
    let finalAmt;
    if(num === 0){finalAmt = amt
    } else if(num == 1){finalAmt = 0.9 * amt
    } else if(num == 2){finalAmt = 0.75 * amt
    } else if(num == 3){finalAmt = 0.65 * amt
    } else if(num == 4){finalAmt = 0.5 * amt
    } else if(num == 5){finalAmt = 0
