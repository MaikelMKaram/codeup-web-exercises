...
console.log((convertDaystoHours(2)));
...
function calculateTax(totalPaid,taxPercent){
    if(typeof Number(totalPaid) == "number" && typeof Number(taxPercent) == "number"){
        let totalIncludingTax = (totalPaid + (totalPaid * (taxPercent / 100)));
